...
Shader "Summon02"
{
	Properties
	{
		...
		_Summon_Amount("Summon_Amount", Range( -1 , 5)) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_73_0 = ( (-0.6 + (( 1.0 - _Summon_Amount ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + ( ( simplePerlin2D139 * ( simplePerlin2D222 / 2.0 ) ) + ( 1.0 - ( ase_vertex3Pos.y / _4_Summon_contrast ) ) ) );
...
/*ASEBEGIN
Version=18935
313;73;1473;753;2177.5;283.6069;2.127942;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1230.638,266.4218;Float;False;Property;_Summon_Amount;Summon_Amount;2;0;Create;True;0;0;0;False;0;False;1;0.19;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;227;-812.9265,982.2269;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;227;0;138;0
WireConnection;158;0;226;0
WireConnection;158;1;227;0
...
ASEEND*/
//CHKSM=DE597717355D36AD0DB7471A0E359C7D22572037